export default {
  ...
  autoFullscreenDesc: `Zoom per adattare il video attivo all'interno della cornice della finestra.`,
  avatar: 'Avatar',
  ...
  chatTimestampDesc: 'Mostra data e ora accanto ai messaggi di chat.',
  ...
  enterJoinDest: 'Immettere un URL sessione Metastream.',
  ...
  next: 'Prossimo',
  nextUp: 'Prossimo',
  networkDisconnectHostDisconnect: 'Host ha chiuso la connessione.',
  networkDisconnectError: 'Errore di rete.',
  networkDisconnectInvalidClientInfo: 'Informazioni sul client non valide.',
  networkDisconnectVersionMismatch: `Mancata corrispondenza della versione client. Il tuo client, o l'host, richiede un aggiornamento.`,
  ...
  networkTroubleshootingHelp: 'Vedi <1>guida Risoluzione Problemi di Rete</1> per aiuto.',
  noticeAddedMedia: 'Aggiunto <Media id="{{mediaId}}">{{mediaTitle}}</Media>',
  noticeMediaError: 'Si è verificato un errore richiedendo {{url}}',
  noticeNowPlaying:
  ...
  requiresPortForward:
    'Richiede <1>impostazione del port forwarding</1> di <3>{{port}}</3> per accettare connessioni dirette.',
  safeBrowse: 'Navigazione sicura',
  safeBrowseDesc: `Richiedere l'approvazione prima di caricare un sito web non riconosciuto.`,
  ...
  theaterModeDesc:
    'Nascondi tutti i contenuti non video sulla pagina web. Si noti che questo potrebbe anche nascondere i sottotitoli "soft".',
  thirdPartyIntegrations: 'Integrazioni Terze Parti',
