...
// Made with love ♥
  ...
  allowTrackingDesc:
    `Des informations d'utilisation anonymes sont envoyées au développeur afin de mieux comprendre comment l'application est utilisée.`,
  avatar: 'Photo de profil',
  avatarCredit: '<0>Image sélectionné fait par</0> <1>{{artist}}</1>',
  cancel: 'Annuler',
  changelog: 'Journal des modifications',
  chat: 'Chat',
  chatColor: 'Couleur du chat',
  chatPlaceholder: 'Message or URL',
  chatRevealHint: 'Appui sur <1></1> pour révéler le chat.',
  ...
  networkDisconnectVersionMismatch: 'Version du client non pris en charge.',
  ...
  noticeMediaError: 'Une erreur s’est produit lors du rajout de : {{url}}',
  noticeNowPlaying:
  ...
  sessionModeOfflineDescription: `Personne n'est pas autorisé à rejoindre.`,
  settings: 'Réglages',
