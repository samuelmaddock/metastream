export default {
  ...
  chatDockToRight: 'Atachar bate-papo a direita',
  ...
  chatUndock: 'Desatachar o bate-papo',
  ...
  networkDisconnectMultiTab: 'Você está hosteando uma sessão do Metastream em mais de um navegador ou aba. Por favor feche as outras abas ou outros navegadores, e recarregue a página.',
