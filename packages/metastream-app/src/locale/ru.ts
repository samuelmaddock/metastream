export default {
  ...
  addMediaCTA: 'Начните с добавления видео в сеанс.',
  admin: 'Администратор',
  ...
  avatar: 'Аватар',
  avatarCredit: '<0>Избранный аватар</0> <1>{{artist}}</1>',
  cancel: 'Отменить',
  changelog: 'Изменения',
  chat: 'Чат',
  chatColor: 'Цвет чата',
  chatMessageFailed: 'Не удаётся отправить ваше сообщение. Пожалуйста, попробуйте снова.',
  ...
  chooseDisplayName: 'Выберите ваше отображаемое имя',
  ...
  findSessionDescription:
    'Присоединяйтесь к каналу <1>#sessions</1> в Discord сообществе Metastream для поиска сеансов других пользователей. Нажмите на логотип Discord ниже, чтобы присоединиться.',
  focusPopup: 'Всплывающее окно фокуса',
  friendCode: 'Код друга',
  getStarted: 'Начать',
  help: 'Помощь',
  info: 'Информация',
  installToDesktop: 'Установить на ПК',
  ...
  kick: 'Выгнать',
  language: 'Язык',
  lockQueue: 'Блокировать очередь',
  moveToTop: 'Переместить наверх',
  maxUsers: 'Максимально пользователей',
  next: 'Следующий',
  nextUp: 'В очереди',
  networkDisconnectHostDisconnect: 'Хост закрыт.',
  networkDisconnectError: 'Сетевая ошибка.',
  networkDisconnectInvalidClientInfo: 'Неверная информация о клиенте.',
  networkDisconnectVersionMismatch: `Несоответствие версии клиента. Ваше клиент или хост необходимо обновить.`,
  networkDisconnectFull: 'Сеанс заполнен.',
  networkDisconnectKicked: 'Удалён из сеанса.',
  networkDisconnectMultiTab:
    'Вы запустили сеанс Metastream более чем с одного браузера или вкладки. Пожалуйста, закройте лишние вкладки или браузеры и перезагрузите страницу.',
  ...
  sessionModePrivateDescription: 'Разрешение на присоединение должно быть явно одобрено.',
  ...
  sharePublicIP:
    'Поделитесь <1>вашим публичным IP-адресом</1>, чтобы позволить друзьям подключаться напрямую.',
  ...
  uiUndock: 'Открепить, плавающее положение',
  ...
  users: 'Пользователи',
  userJoined: '<Username id="{{userId}}">{{username}}</Username> присоединился(ась).',
  userLeft: '<Username id="{{userId}}">{{username}}</Username> вышел(а).',
