export default {
  ...
  findSessionDescription:
    'Присоединяйся к <1>#sessions</1> каналу в Discord сообществе Metastream для поиска сеансов других пользователей. Нажмите на логотип Discord ниже, чтобы присоединиться.',
