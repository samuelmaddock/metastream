export default {
  ...
  chatDockToRight: 'نقل ال دردشة للزاوية',
  ...
  donators: 'المتبرعين',
  duplicate: 'تكرار',
  endSessionTitle: 'إنهاء البث',
  endSessionDescription: 'التغيير إلى بث خاص سوف يقطع الارسال لكل المستخدمين ',
  endSessionModalDescription: 'جميع المستخدمين سيفقدون الإتصال من البث',
  endSessionButton: 'إنهاء البث',
