export default {
  ...
  networkTroubleshootingHelp:
    'Látogasd meg a <1>Hálózati helyreállítások dokumentációt</1> további segítésgért.',
  ...
  sharePublicIP:
    'Oszd meg az IP címedet, <1>your public IP address</1>, hogy engedélyezd a közvetlen csatlakozást.',
