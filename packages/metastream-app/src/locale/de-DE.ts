export default {
  ...
  chat: 'Chat',
  chatDockToRight: 'Chat rechts andocken',
  ...
  chatUndock: 'Chat als schwebendes Fenster abdocken',
  ...
  embedBlocked: '<0>{{host}}</0> wurde eingebunden, weswegen das Popup benötigt wird.',
  ...
  playingInPopup: 'Im Popup abspielen',
